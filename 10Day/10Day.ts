...
inputElemTask05?.addEventListener("keydown", function (e: KeyboardEvent) {
  console.log(e.code);
...
if (paraElemTask06 && paraElemTask05) {
  //
  inputElemTask05?.addEventListener("keyup", function (e: KeyboardEvent) {
    //
    if (e.code == "Space" || e.code == "Enter") {
...
// Task 7
const formElemTask07 = document.getElementById(
  "task07_form"
) as HTMLFormElement;

formElemTask07?.addEventListener("submit", function (e: SubmitEvent) {
  e.preventDefault();
...
//
// Task 8
const selectElemTask08 = document.getElementById(
  "task08_select"
) as HTMLSelectElement;
const paraElemTask08 = document.getElementById(
  "task08_para"
...
// Task 9
const ulElemTask09 = document.getElementById("task09_ul") as HTMLUListElement;

ulElemTask09.addEventListener("click", function (e: MouseEvent) {
...
//
// Task 10
const task10List = document.getElementById("task10List") as HTMLUListElement;
const task10Btn = document.getElementById("task10Btn") as HTMLButtonElement;
...
task10List.addEventListener("click", function (e: MouseEvent) {
  if (
